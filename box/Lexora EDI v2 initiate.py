...
def GenerateMapping():
    ...
    Data.append(['Vanity Weight with Box'])#Alternate name list
    Data.append(None)#Location Column
    Data.append(False)#Can Autofill
    Data.append(None)#Default Value
    Mapping.append(Data)
    ...
    Data.append(['Counter Weight with Box'])#Alternate name list
    Data.append(None)#Location Column
    Data.append(False)#Can Autofill
    Data.append(None)#Default Value
    Mapping.append(Data)
    ...
    Data.append(['Mirror Weight with Box'])#Alternate name list
    Data.append(None)#Location Column
    Data.append(False)#Can Autofill
    Data.append(None)#Default Value
    Mapping.append(Data)
    ...
    Data.append(["Package Height"])#Alternate name list
    Data.append(None)#Location Column
    Data.append(False)#Can Autofill
    Data.append(None)#Default Value
    Mapping.append(Data)
    ...
    Data.append(["Package Width"])#Alternate name list
    Data.append(None)#Location Column
    Data.append(False)#Can Autofill
    Data.append(None)#Default Value
    Mapping.append(Data)
    ...
    Data.append(["Package Depth"])#Alternate name list
    Data.append(None)#Location Column
    Data.append(False)#Can Autofill
    Data.append(None)#Default Value
    Mapping.append(Data)
    ...
    Mapping.append(Data)
    Data = []
    Data.append("SDV Number (USA)")#Name
    Data.append(["SDV Number (USA)"])#Alternate name list
    Data.append(None)#Location Column
    Data.append(False)#Can Autofill
    Data.append("155- VANITIES & MEDICINE CABINETS")#Default Value
    Mapping.append(Data)
...
def GenerateDimensions(Inputs,Outputs):
    for Input in Inputs:
        ...
        for Output in Outputs:
            ...
            if CommonWidth != None and CommonHeight != None and CommonDepth != None and ProductDims != None:
